...
#s(hash-table size 65 test equal rehash-size 1.5 rehash-threshold 0.8125 data ("straight" ("2022-08-25 13:49:36" ("emacs") (:type git :host github :repo "radian-software/straight.el" :files ("straight*.el") :branch "master" :package "straight" :local-repo "straight.el")) "org-elpa" ("2022-08-25 13:49:36" nil (:local-repo nil :package "org-elpa" :type git)) "melpa" ("2022-08-25 13:49:36" nil (:type git :host github :repo "melpa/melpa" :build nil :package "melpa" :local-repo "melpa")) "gnu-elpa-mirror" ("2022-08-25 13:49:36" nil (:type git :host github :repo "emacs-straight/gnu-elpa-mirror" :build nil :package "gnu-elpa-mirror" :local-repo "gnu-elpa-mirror")) "nongnu-elpa" ("2022-08-25 13:49:36" nil (:type git :repo "https://git.savannah.gnu.org/git/emacs/nongnu.git" :local-repo "nongnu-elpa" :build nil :package "nongnu-elpa")) "el-get" ("2022-08-25 13:49:36" nil (:type git :host github :repo "dimitri/el-get" :build nil :files ("*.el" ("recipes" "recipes/el-get.rcp") "methods" "el-get-pkg.el") :flavor melpa :package "el-get" :local-repo "el-get")) "emacsmirror-mirror" ("2022-08-25 13:49:36" nil (:type git :host github :repo "emacs-straight/emacsmirror-mirror" :build nil :package "emacsmirror-mirror" :local-repo "emacsmirror-mirror")) "nano-theme" ("2022-08-24 19:34:13" ("emacs") (:type git :host github :repo "rougier/nano-theme" :files ("*" (:exclude ".git")) :package "nano-theme" :local-repo "nano-theme")) "mindre-theme" ("2022-08-25 13:49:36" ("emacs") (:type git :host github :repo "erikbackman/mindre-theme" :flavor melpa :package "mindre-theme" :local-repo "mindre-theme")) "nano-emacs" ("2022-08-25 13:49:36" nil (:type git :host github :repo "rougier/nano-emacs" :package "nano-emacs" :local-repo "nano-emacs"))))
...
(fn &optional PACKAGE)" t nil) (register-definition-prefixes "straight" '("straight-")) (register-definition-prefixes "straight-ert-print-hack" '("+without-print-limits")) (defvar straight-x-pinned-packages nil "List of pinned packages.") (register-definition-prefixes "straight-x" '("straight-x-")) (provide 'straight-autoloads)) "nano-theme" ((nano-theme nano-theme-autoloads nano-light-theme nano-dark-theme) (when load-file-name (add-to-list 'custom-theme-load-path (file-name-as-directory (file-name-directory load-file-name)))) (register-definition-prefixes "nano-dark-theme" '("nano-dark")) (when load-file-name (add-to-list 'custom-theme-load-path (file-name-as-directory (file-name-directory load-file-name)))) (register-definition-prefixes "nano-light-theme" '("nano-light")) (register-definition-prefixes "nano-theme" '("nano-")) (provide 'nano-theme-autoloads)) "mindre-theme" ((mindre-theme mindre-theme-autoloads) (when (and (boundp 'custom-theme-load-path) load-file-name) (add-to-list 'custom-theme-load-path (file-name-as-directory (file-name-directory load-file-name)))) (run-hooks 'mindre-after-load-hook) (register-definition-prefixes "mindre-theme" '("mindre")) (provide 'mindre-theme-autoloads)) "nano-emacs" ((nano nano-writer nano-theme nano-theme-light nano-theme-dark nano-splash nano-session nano-mu4e nano-modeline nano-minibuffer nano-layout nano-help nano-faces nano-emacs-autoloads nano-defaults nano-counsel nano-compact nano-command nano-colors nano-bindings nano-base-colors nano-agenda) (register-definition-prefixes "nano-agenda" '("center-string" "nano-agenda")) (register-definition-prefixes "nano-base-colors" '("nano-")) (register-definition-prefixes "nano-bindings" '("nano--delete-frame-or-kill-emacs" "new-frame")) (register-definition-prefixes "nano-colors" '("material-color" "nord-color" "open-color")) (register-definition-prefixes "nano-command" '("nano-c")) (register-definition-prefixes "nano-compact" '("nano-modeline-compose")) (register-definition-prefixes "nano-defaults" '("copy-from-osx" "paste-to-osx")) (register-definition-prefixes "nano-faces" '("nano-")) (register-definition-prefixes "nano-help" '("nano-")) (register-definition-prefixes "nano-modeline" '("buffer-menu-mode-header-line" "nano-mode" "shorten-directory" "vc-branch")) (register-definition-prefixes "nano-mu4e" '("-mu4e-resize-headers-window" "mu4e-" "nano-mu4e-dashboard-colors")) (register-definition-prefixes "nano-session" '("unpropertize-kill-ring")) (register-definition-prefixes "nano-splash" '("center-string" "mac-animation-" "nano-splash")) (register-definition-prefixes "nano-theme" '("nano-theme" "set-face")) (register-definition-prefixes "nano-theme-dark" '("nano-theme-set-dark")) (register-definition-prefixes "nano-theme-light" '("nano-theme-set-light")) (autoload 'writer-mode "nano-writer" "

(fn)" t nil) (register-definition-prefixes "nano-writer" '("writer-mode--")) (provide 'nano-emacs-autoloads))))

#s(hash-table size 65 test eq rehash-size 1.5 rehash-threshold 0.8125 data (org-elpa #s(hash-table size 65 test equal rehash-size 1.5 rehash-threshold 0.8125 data (version 14 "melpa" nil "gnu-elpa-mirror" nil "nongnu-elpa" nil "el-get" nil "emacsmirror-mirror" nil "straight" nil "nano-theme" nil "mindre-theme" nil "nano-emacs" nil)) melpa #s(hash-table size 65 test equal rehash-size 1.5 rehash-threshold 0.8125 data (version 2 "gnu-elpa-mirror" nil "nongnu-elpa" nil "el-get" (el-get :type git :flavor melpa :files ("*.el" ("recipes" "recipes/el-get.rcp") "methods" "el-get-pkg.el") :host github :repo "dimitri/el-get") "emacsmirror-mirror" nil "straight" nil "nano-theme" nil "mindre-theme" (mindre-theme :type git :flavor melpa :host github :repo "erikbackman/mindre-theme") "nano-emacs" nil)) gnu-elpa-mirror #s(hash-table size 65 test equal rehash-size 1.5 rehash-threshold 0.8125 data (version 3 "nongnu-elpa" nil "emacsmirror-mirror" nil "straight" nil "nano-theme" (nano-theme :type git :host github :repo "emacs-straight/nano-theme" :files ("*" (:exclude ".git"))) "nano-emacs" nil)) nongnu-elpa #s(hash-table size 65 test equal rehash-size 1.5 rehash-threshold 0.8125 data (version 2 "emacsmirror-mirror" nil "straight" nil "nano-emacs" nil)) el-get #s(hash-table size 65 test equal rehash-size 1.5 rehash-threshold 0.8125 data (version 2 "emacsmirror-mirror" nil "straight" nil "nano-emacs" nil)) emacsmirror-mirror #s(hash-table size 65 test equal rehash-size 1.5 rehash-threshold 0.8125 data (version 2 "straight" (straight :type git :host github :repo "emacsmirror/straight") "nano-emacs" nil))))

("org-elpa" "melpa" "gnu-elpa-mirror" "nongnu-elpa" "el-get" "emacsmirror-mirror" "straight" "emacs" "nano-emacs" "mindre-theme")
